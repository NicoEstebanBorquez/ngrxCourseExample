...
export class FoodEffects {
    ...
    /*@createEffect() getFood$: Observable<Action> = this.actions$.pipe(
        ofType('GET_FOODS'),
        mergeMap(action =>
            this.http.get("http:localhost:222/foods-list").pipe(
    ...
    constructor(
        ...
        private actions$: Actions //Stream of actions dispatched by app
    ) { }
